...
import { useVerifyLandlordOTPMutation, } from "../redux/api/auth.api";
import { useNavigate } from "react-router-dom";

const otpLandlordSchema = z.object({
    identifier: z.string().min(5, "Enter a valid email or mobile number"),
    otp: z.string().length(6, "OTP must be 6 digits"),
});

const LandlordOTP = () => {
    const [verifyOTP, { isSuccess, isError, isLoading }] = useVerifyLandlordOTPMutation();
    ...
    const {
        ...
        resolver: zodResolver(otpLandlordSchema),
    });
