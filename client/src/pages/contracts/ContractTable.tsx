...
const ContractTable = () => {
    ...
    const { data: contractData, isLoading } = useGetAllContractsQuery({
    ...
    const columns = [
        {
            ...
            header: 'Tenant Name',
            cell: (info: any) => info.row.original?.tenant?.name || 'N/A',
        },
        {
            accessorKey: 'tenant.mobile',
            header: 'Mobile',
            cell: (info: any) => info.getValue(),
        },
        {
            accessorKey: 'property.rentAmount',
                ...
                return (
                    <div className="flex gap-4">
                        <button
                            ...
                            onClick={() => navigate(`/landlord/contract/${row._id}`)}
                        >
                            Edit
                        </button>
                        <button
            ...
            <div className="sm:flex sm:items-center justify-center">
                ...
                <div className="mt-4 sm:ml-16 sm:mt-0 flex justify-between gap-5">
                    ...
                    <button
                        ...
                        onClick={() => navigate('/landlord/contract')}
                    >
                        Add Contract
                    </button>
                </div>
                    ...
                    <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        {contractData &&
                            <TableData
                                ...
                                totalPages={contractData?.pagination?.totalPages}
                            />
                        }
                    </div>
                </div>
